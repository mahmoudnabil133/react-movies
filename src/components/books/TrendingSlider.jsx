...
import { getCoverUrl, formatRating, formatRatingCount } from "../../lib/formatters";
import { useI18n } from "../../hooks/useStores";
import WishlistButton from "../shared/WishlistButton";

export default function TrendingSlider({ books, onBookClick }) {
  const { t } = useI18n();
        ...
        <div className="flex">
          {books.map((book, bookIdx) => {
            ...
            return (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-blue-900/30 via-background to-purple-900/30" />
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full flex flex-col md:flex-row gap-8 items-end">
                  <Link to={`/book/${workId}`} className="shrink-0 group/poster hidden sm:block">
                    <img
